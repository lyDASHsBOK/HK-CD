...
function TapNotice() {
    ...
    this.base_.graphics.beginFill('rgba(255, 255, 255, 0.01)').drawCircle(0, 0, 37);
...
TapNotice.prototype.update_ = function() {
    ...
    this.inner_.graphics.setStrokeStyle(3).beginStroke('rgba(255, 255, 255, '+opacity+')').drawCircle(0, 0, 15 + 17 * percent);
    this.inner_.graphics.setStrokeStyle(1).beginStroke('rgba(255, 255, 255, '+opacity+')').drawCircle(0, 0, 20 + 17 * percent);
    this.inner_.graphics.beginFill('rgba(255, 255, 255, 0.85)').drawCircle(0, 0, 10);
};
